...
from NekoRobot.modules.disable import nekocmd
from NekoRobot.modules.sql.redis import start_afk, end_afk, is_user_afk, afk_reason
...
import NekoRobot.modules.helper_funcs.fun_strings as fun
