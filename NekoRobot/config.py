...
class Config(object):
    ...
    OWNER_ID = 5416322777  # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "jashan_bal69x"
    SUPPORT_CHAT = "xtromxsupport"  # Your own group for support, do not add the @
    JOIN_LOGGER = (
        -1001739802989
